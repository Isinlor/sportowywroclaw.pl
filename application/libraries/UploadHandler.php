...
class UploadHandler
{
    ...
    function __construct($options=null) {
        $this->options = array(
            ...
            'upload_dir' => dirname($_SERVER['SCRIPT_FILENAME']).'/galleries/',
            'upload_url' => $this->getFullUrl().'/galleries/',
            'param_name' => 'files',
            ...
            'image_versions' => array(
                ...
                */
                'thumbnail' => array(
                    'upload_dir' => dirname($_SERVER['SCRIPT_FILENAME']).'/galleries/thumbnails/',
                    'upload_url' => $this->getFullUrl().'/galleries/thumbnails/',
                    'max_width' => 80,
                    'max_height' => 80
                )
            )
    ...
    public function post_send($info)
    {
        header('Vary: Accept');
